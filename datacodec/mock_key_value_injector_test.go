...
func (_m *mockKeyValueInjector) ensureSize(size int) {
	_m.Called(size)
}

// setElem provides a mock function with given fields: index, key, value, keyWasNull, valueWasNull, keyDataType, valueDataType
func (_m *mockKeyValueInjector) setElem(index int, key interface{}, value interface{}, keyWasNull bool, valueWasNull bool, keyDataType datatype.DataType, valueDataType datatype.DataType) error {
...
func (_m *mockKeyValueInjector) zeroElem(index int, key interface{}, dataType datatype.DataType) (interface{}, error) {
...
// zeroKey provides a mock function with given fields: index, dataType
func (_m *mockKeyValueInjector) zeroKey(index int, dataType datatype.DataType) (interface{}, error) {
	ret := _m.Called(index, dataType)

	var r0 interface{}
	if rf, ok := ret.Get(0).(func(int, datatype.DataType) interface{}); ok {
		r0 = rf(index, dataType)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(interface{})
		}
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(int, datatype.DataType) error); ok {
		r1 = rf(index, dataType)
	} else {
		r1 = ret.Error(1)
	}
